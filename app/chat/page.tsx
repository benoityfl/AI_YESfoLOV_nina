    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logout-btn:hover { border-color: rgba(200,169,110,0.4); color: rgba(200,169,110,0.7); }
        ...
        .messages-area::-webkit-scrollbar-thumb { background: rgba(200,169,110,0.18); border-radius: 2px; }
        ...
        .orn-line { width: 36px; height: 1px; background: linear-gradient(90deg, transparent, rgba(200,169,110,0.35)); }
        .orn-line.r { background: linear-gradient(270deg, transparent, rgba(200,169,110,0.35)); }
        .orn-diamond { width: 4px; height: 4px; background: #C8A96E; transform: rotate(45deg); opacity: 0.5; }
        ...
        <header className="header">
          <div className="header-left">
            ...
            <div className="header-nina">
              ...
              <span className="header-nina-sub">intimité émotionnelle &amp; sensorielle</span>
            </div>
          </div>
